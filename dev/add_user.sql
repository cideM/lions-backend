...
INSERT INTO users (email, first_name, last_name, address, mobile_phone_nr, landline_nr, birthday, first_name_partner, last_name_partner, birthday_partner, password_digest)
VALUES ("board@test.com", "Big Boss", "Fooblurtb", "board member address", "120348971203", "120348971203", date('1988-09-02'), "foopartner", "parnter last name", date('1988-09-02'), "$2y$04$cZQmyFjUahmyZnojYpM4rOhwWI629ulZKI2Un92/ysvovfMnzN2/e");
