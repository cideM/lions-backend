...
, errors, fast-logger, filepath, filepattern, http-types, katip
, lens, lib, lucid, mtl, resourcet, safe-exceptions, scrypt
, sqlite-simple, string-interpolate, tasty, tasty-hunit, text, time
, transformers, unliftio, uri-encode, uuid, vault, wai, wai-extra
...
mkDerivation {
  ...
  libraryHaskellDepends = [
    ...
    email-validate errors fast-logger filepath http-types katip lens
  ...
  testHaskellDepends = [
    ...
    directory email-validate fast-logger filepath filepattern
    http-types katip lens lucid mtl resourcet safe-exceptions
    sqlite-simple string-interpolate tasty tasty-hunit text time
    transformers unliftio uri-encode vault wai wai-extra warp
  ];
  license = "unknown";
